...
final widgets  = [
  ...
  MyWidget(id: 5,title: "Conversation Bar", favorite: true.obs, img: "assets/png/app_icon.png", code: 'Conversation Bar code 3 componentCard( collection[3],RouteName.widgetsInfo),'),
  ...
  MyWidget(id: 7,title: "GitHub App Bar", favorite: true.obs, img: "assets/png/navbar/navbar2.png", code: 'GitHub bar 2 componentCard( collection[2],RouteName.widgetsInfo),'),
  MyWidget(id: 8,title: "Purple App Bar", favorite: true.obs, img: "assets/png/navbar/navbar4.png", code: 'Purple Bar Code4 componentCard( collection[4],RouteName.widgetsInfo),'),
];
...
final myCollection = [
  Mytechnology(id: 0,title: "App bar", icon: "assets/png/technologies/flutter.png", color: Colors.blue),
  Mytechnology(id: 1,title: "Buttons", icon: "assets/png/technologies/laravel.png", color: const Color(0xFFF05340)),
  Mytechnology(id: 2,title: "Inputs", icon: "assets/png/technologies/github.png", color: Colors.black),
  Mytechnology(id: 3,title: "Sliders", icon: "assets/png/technologies/html.png" , color: Colors.red),
  Mytechnology(id: 4,title: "Cards", icon: "assets/png/technologies/extensions.png", color: const Color.fromARGB(255, 122, 122, 122)),
